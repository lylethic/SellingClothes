const PRODUCTS = [
	{
		...
		desc: [
			{
				RAM: '6 GB',
				bonho: '128 GB, 256 GB hoặc 512 GB',
				kichthuocmanhinh: '6.1 inches',
				hedieuhanh: 'iOS 14',
	...
	},
	{
		...
		color: '#f5a442',
		image:
			'https://cdn.tgdd.vn/Products/Images/42/233130/xiaomi-redmi-9t-6gb-110621-080650-400x400.jpg',
		categoryId: '1',
		isFav: false,
		isBrand: false,
		isSale: true,
		...
		desc: [
			{
				RAM: '4 GB',
				bonho: '64 GB hoặc 128 GB',
				kichthuocmanhinh: '6.53 inches',
				hedieuhanh: 'Android 10, MIUI 12',
	...
	},
	{
		...
		color: '#f5a442',
		image:
			'https://clickbuy.com.vn//uploads/images/2023/09/iphone-15-hong-dai-dien.png',
		categoryId: '1',
		isFav: false,
		isBrand: false,
		isSale: true,
		...
		desc: [
			{
				...
				kichthuocmanhinh: '6.1 inches',
				hedieuhanh: 'iOS 15',
				CPU: 'Apple A15 Bionic Hexa-core',
			},
		],
	},
	{
		...
		name: 'Google Pixel 5',
		color: '#4caf50',
		image: 'https://viostore.vn/wp-content/uploads/2024/03/3-6.png',
		categoryId: '1',
		isFav: false,
		isBrand: true,
		isSale: false,
	...
	{
		id: '6',
		name: 'Tecno Spark 20 Chính Hãng',
		color: '#003791',
		image: 'https://clickbuy.com.vn//uploads/pro/tecno-spark-20_197547.png',
		categoryId: '1',
		isFav: true,
		isBrand: true,
		isSale: true,
		...
		desc: [
			{
				RAM: '4 GB',
				bonho: '64 GB hoặc 128 GB',
				kichthuocmanhinh: '6.8 inches',
				hedieuhanh: 'Android 11, HiOS',
	...
	{
		id: '7',
		name: 'Samsung Galaxy S24 Ultra (5G) 12GB 256GB Chính HãngNintendo Switch',
		color: 'violet',
		image: 'https://clickbuy.com.vn//uploads/pro/2_47731.jpg',
		categoryId: '1',
		isFav: false,
		isBrand: true,
		isSale: false,
	...
	},
	{
		...
		color: '#007db8',
		image:
			'https://laptopvang.com/wp-content/uploads/2024/02/dell-xps-14-9440.jpg',
		categoryId: '2',
		isFav: true,
		isBrand: true,
		isSale: false,
		...
		desc: [
			{
				kichthuocmanhinh:
					'13.3 inches,Various resolutions available (e.g., Full HD, UHD+, OLED)',
				CPU: 'Latest 12th or 13th Gen Intel Core CPUs (i5 or i7)',
				RAM: '8GB, 16GB, or 32GB',
				bonho: '256GB, 512GB, 1TB, or 2TB SSD',
				hedieuhanh: 'Windows 11 Home or Windows 11 Pro',
			},
		],
	},
	{
		...
		color: '#555555',
		image:
			'https://laptopvang.com/wp-content/uploads/2021/10/MacBook-Pro-16-inch-2021-M1-Max-Space-Gray.png',
		categoryId: '2',
		isFav: true,
		isBrand: true,
		isSale: false,
	...
	},
	{
		...
		color: 'violet',
		image:
			'https://cdn.tgdd.vn/Products/Images/1942/303225/smart-tivi-qled-4k-55-inch-samsung-qa55q60c-1.jpg',
		categoryId: '5',
		isFav: false,
		isBrand: true,
		isSale: true,
		...
		desc: [
			{
				kichthuocmanhinh:
					'Various sizes available (e.g., 43, 50, 55, 65 inches), 4K UHD (3840 x 2160)',
				CPU: 'Quantum 4K Processor',
				RAM: '4GB to 12GB',
				bonho: '16GB to 128GB',
				hedieuhanh: 'Tizen OS',
			},
